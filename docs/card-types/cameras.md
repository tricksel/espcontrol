...
If your Home Assistant instance uses a custom port, open **Settings > System > Advanced** and set **Home Assistant Port** to match it. Camera and image cards use this port when downloading snapshots.
